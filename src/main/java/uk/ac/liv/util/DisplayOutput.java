...
import uk.ac.liv.ffmpeg.libavcodec.mpeg12.MpegConstants;
 ...
 */
    ...
    public void move( int[] sourceLuminance, int[] sourceRed, int[] sourceBlue,
        ...
        switch ( mv_type ) {
            case MpegConstants.MV_TYPE_16X16: {
//                System.out.println( "MV_TYPE_16X16" );
            ...
            case MpegConstants.MV_TYPE_FIELD: {
/*             mpeg_motion( sourceLuminance, sourceRed, sourceBlue, 
                             mbX, mbY,
                             0, false, 0, 0,
...
//        clear( oldLuminance ); clear( oldRed ); clear( oldBlue );
		...
		/*
		try {
		    File outputfile = new File("out/frame_" + MXFFile.nbF + ".png");
    ...
    public void showNextScreen( ) {
    	int [] data = new int[ displayX * displayY ];
