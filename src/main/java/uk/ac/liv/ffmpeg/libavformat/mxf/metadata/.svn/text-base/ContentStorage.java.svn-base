...
public class ContentStorage extends MetadataReadTableEntry {

	
	public ContentStorage(MetadataSetType type) {
		super(type);
	}
	...
	public void readChild(Context mxf, ByteReader reader, int tag, int size) throws IOException {
		...
		case 0x1901:
			mxf.setPackagesRefs(reader.read_UIDBatch());
			break;
